            ...
            <div className='space-y-4 sm:flex sm:items-center sm:justify-between sm:gap-6 sm:space-y-0'>
                <div className='flex items-center justify-between sm:order-1 w-full'>
                    ...
                    <div className='flex-1 ml-4 min-w-0'>
                        <p className='text-base font-medium text-white hover:text-emerald-400 hover:underline truncate' onClick={() => navigate('/product/' + item.id)}>
                            {item.name}
                        </p>
                    </div>
                    <div className="inline-flex items-cente">
                        ...
                        {data.length > 1 && (
                            <button
                                ...
                                onClick={() => { data.length > 1 ? removeFromCart(item.id, item.size) : {} }}
                            >
                                <Trash />
                            </button>
                        )}
